...
export class TokenLiquidityPool__getAllowanceOfResultValue0Struct extends ethereum.Tuple {
  get amount(): BigInt {
...
export class TokenLiquidityPool extends ethereum.SmartContract {
  static bind(address: Address): TokenLiquidityPool {
    return new TokenLiquidityPool("TokenLiquidityPool", address);
  }

  getAllowanceOf(
    owner: Address,
    allowee: Address
  ): TokenLiquidityPool__getAllowanceOfResultValue0Struct {
    ...
    return changetype<TokenLiquidityPool__getAllowanceOfResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getAllowanceOf(
    owner: Address,
    allowee: Address
  ): ethereum.CallResult<TokenLiquidityPool__getAllowanceOfResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<TokenLiquidityPool__getAllowanceOfResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }

  getEligibleXOf(liquidityAmount: BigInt): BigInt {
    let result = super.call(
      "getEligibleXOf",
      "getEligibleXOf(uint256):(uint256)",
  ...
  try_getEligibleXOf(liquidityAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getEligibleXOf",
      "getEligibleXOf(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(liquidityAmount)]
  ...
  getEligibleYOf(liquidityAmount: BigInt): BigInt {
    let result = super.call(
      "getEligibleYOf",
      "getEligibleYOf(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(liquidityAmount)]
    );
  ...
  try_getEligibleYOf(liquidityAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getEligibleYOf",
      "getEligibleYOf(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(liquidityAmount)]
  ...
  try_getXTokenAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getXTokenAddress",
      "getXTokenAddress():(address)",
      []
  ...
  getXTokenOutputForSwap(yAmount: BigInt): BigInt {
    let result = super.call(
      "getXTokenOutputForSwap",
      "getXTokenOutputForSwap(uint256):(uint256)",
  ...
  try_getXTokenOutputForSwap(yAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getXTokenOutputForSwap",
      "getXTokenOutputForSwap(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(yAmount)]
  ...
  getYAmountForDepositOfX(xAmount: BigInt): BigInt {
    let result = super.call(
      "getYAmountForDepositOfX",
      "getYAmountForDepositOfX(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(xAmount)]
    );

    return result[0].toBigInt();
  }

  try_getYAmountForDepositOfX(xAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getYAmountForDepositOfX",
      "getYAmountForDepositOfX(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(xAmount)]
  ...
  try_getYTokenAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getYTokenAddress",
      "getYTokenAddress():(address)",
      []
  ...
  getYTokenOutputForSwap(xAmount: BigInt): BigInt {
    let result = super.call(
      "getYTokenOutputForSwap",
      "getYTokenOutputForSwap(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(xAmount)]
    );
  ...
  try_getYTokenOutputForSwap(xAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getYTokenOutputForSwap",
      "getYTokenOutputForSwap(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(xAmount)]
